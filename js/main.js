...
// Make home slovwly fade to transparent as the window scrolls down
...
workBtnContainer.addEventListener('click', (e) =>{
    ...
    //  Remove selection from the previous item and select the current
    ...
    setTimeout(()=> {
        ...
        // for(let project of projets) 랑 같음
...
// 사용자가 실제로 스크롤링할때는 wheel을 사용하게된다.
